...
// Not using BufferedImage frame buffer. No scaling?
...
public abstract class FaySansBuffer extends JPanel implements ActionListener {
...
//	}
	...
	private void drawSprite(int x, int y, BufferedImage img) {
		g2d.drawImage(img, x, y, img.getWidth() * pixelW, img.getHeight() * pixelH, null);
	}
	...
	private void drawPartialSprite(int indexX, int indexY, int x, int y, int w, int h, BufferedImage img) {
		...
		g2d.drawImage(newImg, x * pixelW, y * pixelH, newImg.getWidth() * pixelW, newImg.getHeight() * pixelH, null);
	}
...
//	}
	...
	public void fillCircle(int x, int y, int w, int h, Color c) {
		g2d.setColor(c);
		g2d.fillOval(x, y, w * pixelW, h * pixelH);
	}
	...
	public void showVf2dPoint(Vf2d v, int w, int h, Color c, boolean showlines) {
		g2d.setColor(c);
		g2d.fillOval((int)v.x, (int)v.y, w * pixelW, h * pixelH);
	...
	public void clearConsole(Color c) {
		if(g2d == null) return;
		g2d.setColor(c);
		g2d.fillRect(0, 0, getConsoleWidth() * pixelW, getConsoleHeight() * pixelH);
