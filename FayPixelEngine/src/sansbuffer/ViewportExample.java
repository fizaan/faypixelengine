...
public class ViewportExample extends FaySansBuffer {
	...
	new ViewportExample(1749,987,1,1, "World");
	
	}
	
	public ViewportExample(int len, int hei, int pX, int pY, String title) {
